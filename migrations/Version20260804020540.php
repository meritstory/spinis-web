...
final class Version20260804020540 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE complaint_patient ADD CONSTRAINT FK_6F9237BA19EB6921 FOREIGN KEY (complainant_id) REFERENCES complainant (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE complaint ADD submitter_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE complaint ADD CONSTRAINT FK_5F2732B5919E5513 FOREIGN KEY (submitter_id) REFERENCES complainant (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('CREATE INDEX IDX_5F2732B5919E5513 ON complaint (submitter_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE complaint_patient DROP CONSTRAINT FK_6F9237BA19EB6921');
        ...
        $this->addSql('ALTER TABLE complaint DROP CONSTRAINT FK_5F2732B5919E5513');
        $this->addSql('DROP INDEX IDX_5F2732B5919E5513');
        $this->addSql('ALTER TABLE complaint DROP submitter_id');
